...
import { getAthenaInference, getInference, setForecastingError, setForecastingInference, setPredModalOpen, setSelectedModel } from 'app/modules/store/forecastingSlice';
...
const ForecastingPredModal = () => {
  const { predModalOpen, selectedModel, forecastingInference, forecastingError, forecastingLoading } = useAppSelector(state => state.forecasting);
  ...
  const handleClose = () => {
    ...
    dispatch(setForecastingError(null));
    setUserDate(null);
  };
      ...
      <LocalizationProvider dateAdapter={AdapterDateFns}>
        <Modal open={predModalOpen} onClose={handleClose}>
          <Grid sx={{ ...style, rowGap: 2 }}>
            ...
            <Grid sx={{ height: '80%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
              {forecastingInference && forecastingError === null ? (
