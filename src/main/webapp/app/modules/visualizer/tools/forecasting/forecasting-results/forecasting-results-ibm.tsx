...
import { getProgress, getProgressIbm, saveModel, saveModelIbm } from 'app/modules/store/forecastingSlice';
...
const ForecastingResultsIbm = () => {
  ...
  const handleSubmit = e => {
    dispatch(saveModelIbm(modelInfo));
    setAnchorEl(null);
    handleSnackOpen();
  };
...
export default ForecastingResultsIbm;
