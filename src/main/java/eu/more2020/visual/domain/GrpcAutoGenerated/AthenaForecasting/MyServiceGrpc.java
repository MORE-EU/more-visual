...
public final class MyServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<eu.more2020.visual.domain.GrpcAutoGenerated.AthenaForecasting.HandleDataRequest,
    ...
    if ((getHandleDataMethod = MyServiceGrpc.getHandleDataMethod) == null) {
      synchronized (MyServiceGrpc.class) {
        if ((getHandleDataMethod = MyServiceGrpc.getHandleDataMethod) == null) {
          MyServiceGrpc.getHandleDataMethod = getHandleDataMethod =
              ...
              .setSchemaDescriptor(new MyServiceMethodDescriptorSupplier("HandleData"))
              .build();
        }
      }
    }
